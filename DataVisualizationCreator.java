...
//		MainUI.getInstance().updateStats(scrollPane);
	...
	private void createTableOutput() {
		...
		//Megan's code for adding all necessary client info to the Trader Action's table
		DataFetcher db;
		JTable clientInfo = MainUI.getInstance().getClientInfo();
		String id, strat;
		String coin[] = new String[3];
		for(int i = 0; i < clientInfo.getRowCount(); i++) {
